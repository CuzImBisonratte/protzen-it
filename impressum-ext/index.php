...
<body>
	<main>
		<div class="page fullheight" id="home">
			<nav>
				<img src="/res/img/logo/Arrow-Black.svg" alt="" />
			</nav>
			<main>
				<h1>Impressum</h1>
				<h3>für externe Projekte</h3>
			</main>
			<div class="downArrow">
		...
		<div class="page minheight" id="impressum">
			...
			<ul>
				...
				<li>
					<a href="https://themesjs.de">Themes.js (themesjs.de)</a>
				</li>
				<li>
			...
			<hr>
			Für den Inhalt der voranstehenden Websites verantwortlich:
			<?php
			...
			<h2>Haftung</h2>
			Ich übernehme keine Haftung für die Inhalte externer Links auf jeglichen meiner Projekt-Seiten.
			Für den Inhalt dieser sind ausschließlich deren Betreiber verantwortlich.
		</div>
