...
<body>
    <main>
        ...
        <div class="page minheight" id="datenschutz">
            <h1>Datenschutzerklärung</h1>
            <h2>Kontaktdaten</h2>
            Kontaktionformationen des Verantwortlichen im Sinne der DSGVO sind in der Fußzeile und im Impressum zu finden.
            <h2>Datenerhebung</h2>
            ...
            Diese Seite verwendet keine Cookies, weshalb Sie auch kein Cookie-Banner erhalten.
            <h2>Übermittlung der Daten an Dritte</h2>
            Es werden keine Daten an Dritte übermittelt. Dieses Webangebot wird bei Netcup gehostet, deren Datenschutzbestimmungen Sie hier finden können: <a href="https://www.netcup.com/de/kontakt/datenschutzerklaerung" target="_blank">Datenschutzerklärung Netcup</a>.
        </div>
